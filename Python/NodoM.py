...
class NodoM():
    def __init__ (self, empresa=None, departamento=None, nombre=None, contrasenia=None, usuario=None, arriba=None, abajo=None, derecha=None, izquierda=None, profundidad=None):
        ...
        self.nodoAvl = NodoAVL()
        self.raiz = None
        
    def retornarNodoAVL(self):
        return self.nodoAvl
